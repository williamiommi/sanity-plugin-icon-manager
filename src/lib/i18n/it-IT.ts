export default {
  ...
  'dialog.add.filter.style.stroke.label': 'Tratto',
  'dialog.add.filter.style.fill.label': 'Riempimento',
  'dialog.add.filter.palette.label': 'Palette:',
  'dialog.add.filter.palette.mono.label': 'Monocromo',
  'dialog.add.filter.palette.poly.label': 'Policromo',
  'dialog.add.filter.collection.label': 'Collezione:',
